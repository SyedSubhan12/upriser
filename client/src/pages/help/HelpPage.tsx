            ...
            <div className="mx-auto max-w-4xl px-4 py-12 md:px-6 md:py-16">
                ...
                <div className="space-y-8">
                    ...
                    <HelpSection
                        ...
                        description="Get started with ExamsValley"
                    >
                    ...
                    >
                        <div className="space-y-2">
                            <FAQItem
                                question="Is ExamsValley free to use?"
                                answer="Yes! ExamsValley is completely free to access. Browse all curricula, subjects, and resources without any subscription or payment."
                            />
                            <FAQItem
                                ...
                                <Card>
                                    <CardContent className="flex items-center gap-4 p-4">
                                        ...
                                        <div>
                                            ...
                                            <a
                                                href="mailto:support@ExamsValley.com"
                                                className="text-sm text-primary hover:underline"
                                            >
                                                support@ExamsValley.com
                                            </a>
                                        </div>
                                    </CardContent>
                                </Card>
